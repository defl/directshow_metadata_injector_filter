...
from directshow_metadata_injector_filter.hdr_metadata import HDRMetaData, PrimaryColorSpace
...
while True:
    ...
    if data['HDR']:
        ...
        if eotf == 0:
            ...
            raise Exception("Don't know HDR EOTF: {}".format(eotf))
        ...
        pcs = hdr.primary_color_space()
        if pcs == PrimaryColorSpace.UNKNOWN:
            output['primaries'] = 0  # Unknown
        elif pcs == PrimaryColorSpace.REC_709:
            output['primaries'] = 2  # BT.709
        elif pcs == PrimaryColorSpace.BT2020:
            output['primaries'] = 9  # BT.2020
        elif pcs == PrimaryColorSpace.DCI_P3:
            output['primaries'] = 11  # DCI-P3
        else:
            raise Exception("Don't know HDR primaries color space: {}".format(pcs))

        # TODO: transfer_matrix
